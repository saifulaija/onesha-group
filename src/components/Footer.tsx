...
//             <a
//               href="/about"
//               className="relative text-[#0b1d33] transition-colors duration-300 hover:text-[#d98e2b] after:absolute after:-bottom-1 after:left-0 after:h-[2px] after:w-0 after:bg-[#d98e2b] after:transition-all after:duration-300 hover:after:w-full"
//             >
//               About
//             </a>
...
//             <p className="mt-1 text-xs text-[#345d8a]">
