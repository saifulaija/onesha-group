...
//     // catch late layout shifts (fonts/images loading in the header)
...
//   /* -------- ken-burns entrance: start slightly zoomed, settle to 1 -------- */
//   useEffect(() => {
//     setZoomed(false);
//     let raf1 = requestAnimationFrame(() => {
//       raf1 = requestAnimationFrame(() => setZoomed(true));
//     });
...
//       <style>{`
//         @keyframes oneshaAmbientZoom { 0% { transform: scale(1); } 100% { transform: scale(1.07); } }
...
//                   animation:
//                     i === index && zoomed
//                       ? "oneshaAmbientZoom 16s ease-in-out infinite alternate"
//                       : "none",
//                 }}
//               />
//             </div>
...
//           {i === index && (
//             <div className="relative z-[3] mx-auto flex h-full w-full max-w-[1320px] flex-col justify-start pt-8 pb-8 px-5 sm:justify-center sm:px-8 sm:pt-0 sm:pb-20">
//               <div
