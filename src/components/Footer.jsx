...
const Footer = () => {
  return (
    <div className="max-w-[1320px] mx-auto px-6 sm:px-8">
      <footer className="flex flex-wrap items-center justify-center gap-3 border-t border-[#0b1d33]/[0.14] py-8 text-xs text-[#345d8a] sm:justify-between sm:text-left">
